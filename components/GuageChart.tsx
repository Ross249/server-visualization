...
const GuageChart = (props: any) => {
  ...
  useEffect(() => {
    ...
    const width: any = chart?.clientWidth;
    const height: any = chart?.clientHeight;
    ...
    tick
      ...
      .attrTween("transform", function () {
        ...
        const i = d3.interpolate(angleToDegree(0), angleToDegree(90)); //取插值
        return function (t) {
          return "rotate(" + i(t) + ")";
        };
      });
